...
vec getTangent(pt[] controls, float t){
  ...
  //6gt5−6ft5+30f(1−t)t4−30e(1−t)t4−60d(1−t)2t3+60e(1−t)2t3+60d(1−t)3t2−60c(1−t)3t2+30c(1−t)4t−30b(1−t)4t+6b(1−t)5−6a(1−t)5
  pt b1 = P(6*t*5,g);
  pt a1 = P(-6*t*5,f);
...
void generateAvgCurve(pt[] curve1, pt[] curve2){
  ...
  for(int i = 0; i < 1000; i ++){
    println("c1:"+c1tan.x+","+c1tan.y+","+c1tan.z);
    println("c2:"+c1tan.x+","+c1tan.y+","+c1tan.z);
